...
export default function WorkWithBadMarketingForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setStatus({ state: "success", message: "Thank you! Your submission has been received!" });
      setForm({
        firstName: "",
        lastName: "",
        email: "",
      ...
      setStatus({ state: "error", message: "Oops! Something went wrong while submitting the form." });
    }
  }
      ...
      <section className="relative py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/20">
            ...
            <span className="text-sm font-semibold">We're accepting new clients</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Ready to transform your business? Let's discuss how we can drive exceptional results together.
          </p>
            ...
            <div className="space-y-8">
              <div className="relative">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Please fill out this application, and one of our team members will get back to you as soon as possible.
                </p>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 border border-blue-100 shadow-2xl group hover:shadow-3xl transition-all duration-500">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Need to reach us another way?</h3>
                <p className="text-gray-600 text-lg mb-6">
                  Check our social links in the footer or send us an email at{" "}
                  <a href="mailto:hello@yourbrand.com" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors underline">
                    hello@yourbrand.com
                  </a>.
                </p>
              ...
              <div className="space-y-6 pt-8">
                <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 group hover:border-blue-200">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Call Us Directly</h3>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-2xl bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 group hover:border-blue-200">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Send Us an Email</h3>
                    <p className="text-gray-600 text-lg font-medium">hello@yourbrand.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Project Application</h3>
                  <p className="text-gray-600">Tell us about your business goals</p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label className="flex flex-col group">
                      <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">First name *</span>
                      <input 
                        name="firstName" 
                    ...
                    <label className="flex flex-col group">
                      <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Last name *</span>
                      <input 
                        name="lastName" 
                        value={form.lastName} 
                        onChange={handleChange} 
                  ...
                  {/* Contact Fields */}
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Email *</span>
                    <input 
                      name="email" 
                      value={form.email} 
                      onChange={handleChange} 
                  ...
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Phone number *</span>
                    <input 
                      name="phone" 
                      value={form.phone} 
                      onChange={handleChange} 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label className="flex flex-col group">
                      <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Company</span>
                      <input 
                        name="company" 
                        value={form.company} 
                        onChange={handleChange} 
                    ...
                    <label className="flex flex-col group">
                      <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Website</span>
                      <input 
                        name="website" 
                        value={form.website} 
                        onChange={handleChange} 
                  ...
                  {/* Business Type */}
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">What Kind Of Business?</span>
                    <select 
                      name="businessType" 
                  ...
                  {/* Instagram */}
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Business Instagram</span>
                    <input 
                      name="instagram" 
                  ...
                  <div className="group">
                    <p className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">What Solutions are you interested in?</p>
                    <p className="text-sm text-gray-500 mb-4">Select ALL that apply</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {solutionList.map((s) => (
                        <label key={s} className="flex items-center gap-3 p-4 rounded-xl border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all duration-300 group-hover:shadow-lg">
                          <input 
                            type="checkbox" 
                            name={s} 
                  ...
                  {/* Revenue */}
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">What's your monthly revenue?</span>
                    <select 
                      name="revenue" 
                      value={form.revenue} 
                      onChange={handleChange} 
                  ...
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">How did you hear about us?</span>
                    <input 
                      name="heardFrom" 
                  ...
                  {/* Current Marketing */}
                  <label className="flex flex-col group">
                    <span className="text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">What kind of marketing are you currently doing?</span>
                    <textarea 
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100">
                    <div className="text-xs text-gray-600 mb-4">
                      <p>By submitting this form, you agree to receive text messages from us. By signing up via text, you agree to receive recurring automated marketing messages, including call reminders, at the phone number provided. Consent is not a condition of purchase. Text HELP for Help or Reply STOP to unsubscribe. Message frequency varies. Msg & data rates may apply. Your Privacy is our priority. Your information will not be shared.</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <label className="flex items-center gap-3">
                        <input 
                          ...
                          className="rounded border-2 border-gray-300 text-blue-600 focus:ring-blue-500 w-5 h-5"
                        />
                        <span className="text-sm font-semibold text-gray-700">I agree to receive messages</span>
                      </label>
                    </div>
                  </div>
      ...
      <section className="relative py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Let's schedule a call to discuss your project and see how we can help you achieve remarkable results.
          </p>
